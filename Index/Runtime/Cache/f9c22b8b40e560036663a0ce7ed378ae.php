			...
			<div class="main-header">
				...
				<nav id="site-menu" role="navigation">
					<ul class="main-menu hidden-sm hidden-xs">
						...
						<li id="second" >
							<a href="__APP__/Products/products">最新商品</a>
						</li>
						<li id="third" >
							<a href="__APP__/Mixproducts/products">混合商品</a>
						</li>
						<li id="fourth">
							<a href="__APP__/Jifenproducts/products">积分商品</a>
						</li>
		...
		<div class="flexslider">
			<ul class="slides">
				...
				<li>
					...
					<img src="__PUBLIC__/index/rev-slider/img/slides/1.jpg" alt="" />
				</li>

				<!-- THE SECOND SLIDE 第二张滑动图片 -->
				<li style="background: #fa6f57;">
					<!-- THE MAIN IMAGE IN THE SLIDE 主图像幻灯片 -->
					<img src="__PUBLIC__/index/rev-slider/img/slides/2.jpg" alt="" />
				...
				<li>
					<!-- THE MAIN IMAGE IN THE SLIDE 主图像幻灯片 -->
					<img src="__PUBLIC__/index/rev-slider/img/slides/3.jpg" alt="" />
				</li>
			</ul>
		</div>
	</div>
					...
					<div class="col-xs-12 col-sm-6 col-md-4">
						<section class="widget widget-text">
							...
							<div class="widget-content">
								...
								<p>目标销售对象为都市时尚人群，公司旗下有超过500人的专业时尚设计师团队，并在韩国拥有分公司，同1000余家时尚品牌公司保持着紧密的、全方位的合作关系。
								</p>
							</div>
						</section>
					</div>
